    ...
    return(
        <div className='flex-col flex items-center lg:mt-14 sm:mt-2'>
                ...
                <div className='flex flex-col w-full mt-16'>
                    ...
                    <button className="drop-shadow-xl self-center text-white mt-2 px-2 py-2 bg-green-600 rounded-lg hover:bg-green-700 ">Submit</button>
                </div>
                <button onClick={ () => { router.reload(); localStorage.removeItem('luncheroToken') }} className="mt-40 drop-shadow-xl text-white px-6 py-4 bg-green-600 rounded-lg hover:bg-green-700 ">Log out</button>
        </div>
    )
}
