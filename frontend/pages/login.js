    ...
    return(
        < div className='grid grid-cols-1  sm:grid-cols-1 h-screen w-full'>
            ...
            <div className=' flex flex-col  justify-center'>
                <form onSubmit={onSubmit} className='xxl:w-96 xxl:h-144  md:max-w-sm sm:max-w-xs drop-shadow-2xl mx-auto bg-white border-green-500 solid border-2 p-20 sm:p-14 px-20 rounded-lg'>
                    ...
                    <div className='flex flex-col  text-black py-6 xxl:py-12'>
                        ...
                        <input ref={emailRef} className={`rounded-lg text-black bg-gray-300 mt-2 outline-none p-2 border-solid border-2  ${error ? 'border-red-600' : 'border focus:border-gray-300'}`}/>
                    </div>
                    <div className='flex flex-col text-black py-4 relative'>
                        <label className={'font-bold'}>Hasło</label>
                        <input ref={passwordRef} role='passwordInput' className={`rounded-lg text-black bg-gray-300 mt-2 outline-none p-2 border-solid border-2  ${error ? 'border-red-600' : 'border focus:border-gray-300'}`}
