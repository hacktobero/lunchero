...
const Register = () => {
  ...
  return (
    <div className="grid grid-cols-1 text-lg sm:grid-cols-1 h-screen w-full">
        ...
        <form onSubmit={onSubmit} className="xxl:w-96 xxl:h-144  md:max-w-sm sm:max-w-xs drop-shadow-2xl mx-auto bg-white border-green-500 solid border-2 sm:p-12 px-20 rounded-lg">
