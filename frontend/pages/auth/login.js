        ...
        < div className='grid grid-cols-1 text-lg  sm:grid-cols-1 h-screen w-full'>
           <h1 className='fixed text-green-400 border-b-2 border-black font-bold lg:text-6xl sm:text-3xl top-5 justify-self-center lg:right-28 lg:top-10'>Lunchero</h1>
            <div className=' flex flex-col  justify-center'>
                <form onSubmit={onSubmit} className='xxl:w-96 xxl:h-144  md:max-w-sm font-bold sm:max-w-xs drop-shadow-2xl mx-auto bg-white border-green-500 solid border-2 sm:p-10 rounded-lg'>
                    ...
                    <div className='flex flex-col  text-black pb-14 py-8 xxl:py-12'>
                        <label className='relative'>
                            <input ref={emailRef} type="text" placeholder="Input" className={`px-4 w-64 sm:w-60 p-2 text-black text-sm border-2 rounded-lg border-opacity-50 outline-none focus:border-green-500 placeholder-gray-300 placeholder-opacity-0 transition duration-200${error ? 'border-red-600' : 'focus:border-green-500'} `} />
