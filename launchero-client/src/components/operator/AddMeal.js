                                ...
                                <div className="grid w-9/10 xl:mt-0 xxl:mt-10 sm:mt-0 text-black self-center py-6 px-5 relative">
                                    <form className='grid grid-cols-2 '>
                                        ...
                                        <div className='flex xl:mb-5 xxl:mb-10 sm:mb-0 my-4 col-span-2 gap-14'>
                                            ...
                                            <input className={'rounded-lg flex-col text-black bg-gray-300 mt-2  outline-none p-2 shadow-green   focus:border-gray-300'} ></input>
                                            </div>

                                            <div className='grid w-1/4'>
                                            <label className={'font-bold'}>Preferences</label>
                                            <select required className="flex-col rounded-lg text-black bg-gray-300 mt-2  outline-none p-2    shadow-green focus:border-gray-300">
                                                <option value=""></option>
                                        ...
                                        <input className={'rounded-lg text-black bg-gray-300 mt-2  outline-none p-2  shadow-green focus:border-gray-300'} ></input>
                                        </div>
                                        <div className='flex my-4 col-span-2 gap-40'>
                                            <div className='grid col-span-1 w-1/2'>
                                                <label className={'font-bold'}>Type</label>
                                                <select required className="flex-col rounded-lg text-black bg-gray-300   outline-none p-2 shadow-green focus:border-gray-300">
                                                    <option value=""></option>
